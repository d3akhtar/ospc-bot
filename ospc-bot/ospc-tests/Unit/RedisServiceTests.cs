...
namespace OSPC.Tests.Unit
{
	public class RedisServiceTests
	{
		...
		private Mock<ILogger<RedisService>> _loggerMock;
		private Mock<IOptions<CacheOptions>> _cacheOptionsMock;
		...
		public async Task InvalidateKeysTest()
		{
			...
			for (int i = 0; i < numberOfKeys; i++) keysToInvalidate.Add(Guid.NewGuid().ToString());
